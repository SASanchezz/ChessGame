...
public class Knight extends AbstractFigure {
    ...
    public ArrayList<Cell> AllowedMoves() {
        ...
        if (num <= 6 && sign != 7) {
            ...
            if (getCellSet().get(G1).getOccupiedBy() == Color );
        ...
        if (num != 8 && sign <= 5) {
            ...
            if (getCellSet().get(G2).getOccupiedBy() == Color );
        ...
        if (num != 1 && sign <= 5) {
            ...
            if (getCellSet().get(G3).getOccupiedBy() == Color );
        ...
        if (num >= 3 && sign != 7) {
            ...
            if (getCellSet().get(G4).getOccupiedBy() == Color );
        ...
        if (num >= 3 && sign != 0) {
            ...
            if (getCellSet().get(G5).getOccupiedBy() == Color );
        ...
        if (num != 1 && sign >= 2) {
            ...
            if (getCellSet().get(G6).getOccupiedBy() == Color );
        ...
        if (num != 8 && sign >= 2) {
            ...
            if (getCellSet().get(G7).getOccupiedBy() == Color );
        ...
        if (num <= 6 && sign != 0) {
            ...
            if (getCellSet().get(G8).getOccupiedBy() == Color );
